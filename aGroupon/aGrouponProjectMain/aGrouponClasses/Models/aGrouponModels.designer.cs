...
namespace aGrouponClasses.Models
{
    ...
    partial void DeletetContent(tContent instance);
		...
		public System.Data.Linq.Table<tContent> tContents
		{
			get
			{
				return this.GetTable<tContent>();
			}
		}
	}
	...
	public partial class tUser : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<tComment> _tComments;
    ...
    partial void OnLastLoginDateChanged();
		...
		public tUser()
		{
			...
			this._tComments = new EntitySet<tComment>(new Action<tComment>(this.attach_tComments), new Action<tComment>(this.detach_tComments));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tUser_tComment", Storage="_tComments", ThisKey="IDUser", OtherKey="IDUser")]
		public EntitySet<tComment> tComments
		{
			get
			{
				return this._tComments;
			}
			set
			{
				this._tComments.Assign(value);
			}
		}
		...
		private void attach_tComments(tComment entity)
		{
			this.SendPropertyChanging();
			entity.tUser = this;
		}
		
		private void detach_tComments(tComment entity)
		{
			this.SendPropertyChanging();
			entity.tUser = null;
		}
    ...
    partial void OnIDMainTableChanging(int value);
    partial void OnIDMainTableChanged();
    partial void OnIDUserChanging(int value);
    partial void OnIDUserChanged();
    partial void OnCommentChanging(string value);
    partial void OnCommentChanged();
    partial void OnApproveFlagChanging(bool value);
    ...
    partial void OnDateAddedChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IDMainTable", DbType="Int NOT NULL")]
		public int IDMainTable
		{
			get
			{
				return this._IDMainTable;
			}
			set
			{
				if ((this._IDMainTable != value))
				{
					this.OnIDMainTableChanging(value);
					this.SendPropertyChanging();
					this._IDMainTable = value;
					this.SendPropertyChanged("IDMainTable");
					this.OnIDMainTableChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ApproveFlag", DbType="Bit NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tUser_tComment", Storage="_tUser", ThisKey="IDUser", OtherKey="IDUser", IsForeignKey=true)]
		public tUser tUser
		{
			get
			{
			...
			set
			{
							...
							|| (this._tUser.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._tUser.Entity = null;
						previousValue.tComments.Remove(this);
					}
					this._tUser.Entity = value;
					if ((value != null))
					{
						value.tComments.Add(this);
	...
	public partial class tCategory : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<tContent> _tContents;
    ...
    partial void OnSortChanged();
		...
		public tCategory()
		{
			...
			this._tDeals = new EntitySet<tDeal>(new Action<tDeal>(this.attach_tDeals), new Action<tDeal>(this.detach_tDeals));
			this._tContents = new EntitySet<tContent>(new Action<tContent>(this.attach_tContents), new Action<tContent>(this.detach_tContents));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tCategory_tContent", Storage="_tContents", ThisKey="IDCategory", OtherKey="IDCategory")]
		public EntitySet<tContent> tContents
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tContent")]
	public partial class tContent : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnIDContentChanging(int value);
    ...
    partial void OnDateAddedChanging(System.DateTime value);
    partial void OnDateAddedChanged();
    partial void OnShowInMenuFlagChanging(bool value);
    partial void OnShowInMenuFlagChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IDContent", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int IDContent
		{
			...
			set
			{
				if ((this._IDContent != value))
				{
					this.OnIDContentChanging(value);
					this.SendPropertyChanging();
					this._IDContent = value;
					this.SendPropertyChanged("IDContent");
					this.OnIDContentChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ShowInMenuFlag", DbType="Bit NOT NULL")]
		public bool ShowInMenuFlag
		{
			get
			{
				return this._ShowInMenuFlag;
			}
			set
			{
				if ((this._ShowInMenuFlag != value))
				{
					this.OnShowInMenuFlagChanging(value);
					this.SendPropertyChanging();
					this._ShowInMenuFlag = value;
					this.SendPropertyChanged("ShowInMenuFlag");
					this.OnShowInMenuFlagChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tCategory_tContent", Storage="_tCategory", ThisKey="IDCategory", OtherKey="IDCategory", IsForeignKey=true)]
		public tCategory tCategory
		{
			get
			{
			...
			set
			{
							...
							|| (this._tCategory.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._tCategory.Entity = null;
						previousValue.tContents.Remove(this);
					}
					this._tCategory.Entity = value;
					if ((value != null))
					{
						value.tContents.Add(this);
